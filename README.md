...
- The dataset comprised acoustic data from adults who do not stutter (AWNS, 18 participants) and adults who stutter (AWS, 17 participants). AWNS data were obtained from the open source FluencyBank dataset. AWS data were collect at the Interpersonal Neurophysiology Lab at UD. 12 out of 18 AWNS participants provided permission to share their data.  

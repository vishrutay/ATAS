...
In addition to the original ATAS workflow for adults who stutter (AWS/AWNS), this repository also includes an extended pipeline for speech timing analysis in children who stutter (CWS/CWNS): `Versions/v1.1_CWS_CWNS_ATAS_Pipeline/`
...
- The dataset comprised acoustic data from adults who do not stutter (AWNS, 18 participants) and adults who stutter (AWS, 17 participants). AWNS data were obtained from the open source FluencyBank dataset. AWS data were collected at the Interpersonal Neurophysiology Lab at UD. 12 out of 18 AWNS participants provided permission to share their data.  
